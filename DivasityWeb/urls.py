...
from BackEnd import views as diva_views
...
urlpatterns = [
    ...
    path('register/', diva_views.register, name='register'),
    ...
    path('password-reset/done/',
        auth_views.PasswordResetDoneView.as_view(template_name='BackEnd/password_reset_done.html'),
    ...
    path('password-reset-complete/',
        auth_views.PasswordResetCompleteView.as_view(template_name='BackEnd/password_reset_complete.html'),
